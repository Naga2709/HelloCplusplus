			...
			// main sebagai tanda inti program
{
	...
	/*
	memanggil sebuah fungsi untuk disamakan ke nilai
	*&a menunjukkan pointer ke a contohnya alamat dari variabel a dan
	*&b menunjukkan pointer ke b contohnya alamat dari variabel b
	*/
	swap ( &a, &b );
...
// definisi fungsi untuk disamakan ke nilai
void swap ( int *x, int *y )
{
	int temp;
	temp = *x; // menyimpan nilai pada x
	*x = *y; // sisipkan y ke x
